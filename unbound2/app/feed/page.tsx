...
>
{/* Single outline silhouette with REAL horns (not wires) */}
<path
d="
M7.2 8.8
...
if (cErr) {
// counts not critical; keep likes at least
setLikeCounts(lc);
setLikedByMe(lbm);
setCommentCounts({});
return;
...
// fetch author profiles so posts don't look like "whoever is logged in wrote it"
...
// ignore double click duplicates quietly
...
{/* Spark CSS (no canvas, no painting) */}
<style>{`
...
{/* Author + time (this fixes the "looks like whoever is logged in posted it") */}
